...
const UserList = () => {
  ...
  // ✅ FIX: Use ref to prevent initial double fetch
  const isInitialMount = useRef(true);

  // ✅ FIX: Memoize fetchUsers to prevent recreation on every render
  ...
  }, [pagination.page, pagination.limit, filters, showToast]); // ✅ Added proper dependencies

  // ✅ FIX: Use useEffect with proper dependency array
  useEffect(() => {
    if (isInitialMount.current) {
      isInitialMount.current = false;
    }
    fetchUsers();
  }, [fetchUsers]); // ✅ fetchUsers is now memoized

  // ✅ FIX: Handle filter changes with debounce concept
  ...
  }, [selectedUser, showToast, fetchUsers]);
