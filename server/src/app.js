...
// // ==================== TASK MANAGEMENT API ====================
// app.use('/api/v1/tasks', taskRoutes);                    // Task CRUD
// app.use('/api/v1/task-assignments', taskAssignmentRoutes); // Task Assignment
// app.use('/api/v1/task-progress', taskProgressRoutes);     // Task Progress

// // ==================== ATTENDANCE & LEAVE API ====================
// app.use('/api/v1/attendance', attendanceRoutes);          // Attendance Management
// app.use('/api/v1/leave', leaveRoutes);                    // Leave Management

// // ==================== PAYROLL & SALARY API ====================
// app.use('/api/v1/salary', salaryRoutes);                  // Salary Management
// app.use('/api/v1/payroll', payrollRoutes);                // Payroll Processing

// // ==================== SLA & TRACKING API ====================
// app.use('/api/v1/sla', slaRoutes);                       // SLA Monitoring
// app.use('/api/v1/tracking', trackingRoutes);              // GPS Tracking
// app.use('/api/v1/geofences', geofenceRoutes);             // Geofence Management

// // ==================== COMPLAINT API ====================
// app.use('/api/v1/complaints', complaintRoutes);           // Complaint Management

// // ==================== 🔴 NEW: CHAT API ====================
// app.use('/api/v1/chat', chatRoutes);                      // Real-time Chat System

// // ==================== 🔴 NEW: REPORT API ====================
// app.use('/api/v1/reports', reportRoutes);                 // Report Generation

// // ==================== 🔴 NEW: NOTIFICATION API ====================
// app.use('/api/v1/notifications', notificationRoutes);     // Push/Email Notifications

// // ==================== 🔴 NEW: DASHBOARD API ====================
// app.use('/api/v1/dashboard', dashboardRoutes);            // Dashboard Analytics
