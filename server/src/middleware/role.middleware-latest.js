...
//     const roleValue = role.name || role.role || 'user';
...
// /**
//  * 🔴 FIXED: AUTHORIZE FUNCTION - For ROUTE access control
//  * This is the main function used in routes
//  */
// const authorize = (...allowedRoles) => {
//   // If no roles specified, default to admin and super_admin
//   if (allowedRoles.length === 0) {
...
//   roleMiddleware,
//   roleHierarchyMiddleware,
//   authorize,           // 🔴 Main function used in routes
//   checkPermission,
//   checkAnyPermission,
//   canAccessResource,
//   canAccessBuilding,
